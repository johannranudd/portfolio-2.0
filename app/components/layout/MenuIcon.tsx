  ...
  return (
    ...
    >
      <m.div
        ...
        className={`absolute top-1/2 left-[5.8px] w-6 h-[2.5px]  duration-[400ms] rounded-md bg-primary group-hover:bg-thirdClr`}
      ></m.div>
      <m.div
        initial={{ rotate: -60 }}
      ...
      ></m.div>
      <div
        className={`absolute top-[calc(50%+10px)]  w-6 h-[2.5px]  duration-[100ms] rounded-md bg-primary group-hover:bg-thirdClr 
